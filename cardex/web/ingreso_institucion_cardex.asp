...
<form method="POST" name="ELEGIROPCIONES" action="ingreso_uoperativa.asp">
  ...
  <table border="1" width="19%" bgcolor="#9999FF">
    <tr>
      <td width="74%" align="right" bgcolor="#3366FF">
        <p align="right"><font color="#FFFFFF" face="Agency FB"><b>Provincia:&nbsp;&nbsp;</b></font> </td>
      <td width="26%"><input type="radio" name="opcion_institucion" value="provincia" checked tabindex="1"></td>
    </tr>
    <tr>
      <td width="74%" align="right" bgcolor="#3366FF"><font color="#FFFFFF" face="Agency FB"><b>Area:&nbsp;&nbsp;</b></font> </td>
      <td width="26%"><input type="radio" name="opcion_institucion" value="area" tabindex="2"></td>
    </tr>
  </table>
    </center>
  </div>
