...
<form method="POST" name="ELEGIROPCIONES" action="cabmodificacion_cardex.asp">
  ...
  <table border="1" width="19%" bgcolor="#9999FF">
    ...
    <tr>
      <td width="74%" align="right" bgcolor="#3366FF"><font color="#FFFFFF" face="Agency FB"><b>Cédula:&nbsp;&nbsp;</b></font> </td>
      <td width="26%"><input type="radio" name="opcion_consulta" value="cedula" tabindex="2"></td>
    </tr>
    <tr>
      <td width="74%" align="right" bgcolor="#3366FF"><font color="#FFFFFF" face="Agency FB"><b>Historia
        Clínica:&nbsp;&nbsp;</b></font> </td>
      <td width="26%"><input type="radio" name="opcion_consulta" value="historia_clinica" tabindex="3"></td>
    </tr>
    <tr>
      <td width="74%" align="right" bgcolor="#3366FF"><font color="#FFFFFF" face="Agency FB"><b>Fecha
        Nacimiento:&nbsp;&nbsp;</b></font> </td>
      <td width="26%"><input type="radio" name="opcion_consulta" value="fecha_nacimiento" tabindex="4"></td>
    </tr>
  </table>
    </center>
  </div>
