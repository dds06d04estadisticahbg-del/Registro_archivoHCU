...
session("opcionu")=Request.Form("opcion_consulta")
%>
...
<form method="POST" name="INGRESARDATO" action="resmodificacion_usuario_cardex.asp">
  ...
  <table border="1" width="57%" bgcolor="#9999FF">
    <tr>
      ...
      <td width="76%"><input type="text" name="dato_consultau" size="40" tabindex="1"></td>
    </tr>
  </table>
    </center>
  </div>
