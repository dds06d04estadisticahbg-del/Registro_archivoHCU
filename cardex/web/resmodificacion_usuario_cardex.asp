...
<body>
<b><font color="#FF0000" face="Abadi MT Condensed Light">MODIFICACION USUARIO</font><br>
</b>
<br>
</p>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-width:3; border-collapse: collapse" bordercolor="#000080" width="100%" id=tabla1 height="65">
	...
	%>
    <tr>
    <td width="30%" align="center" bgcolor="#CCCCFF" bordercolor="#FFFFFF"><font color="#000000" size="2"><b> <a href="formodificacion_usuario_cardex.asp?codigou=<%=objDatosBDD.Fields(0)%>"><%=objDatosBDD.Fields(1)%></a></b></font>&nbsp;</td>
...
<br><br><br><br>
<center>No se han encontrado registros para su consulta, <a href="modificacion_usuario_cardex.asp">vuélvalo a intentar</a>  por favor! </center>
</p>
